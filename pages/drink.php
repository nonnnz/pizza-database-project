...
<body>
    <div class="home-category" style = "margin-top: 80px ">
        ...
        <div class="category_container" >
            ...
            <a href="#">
                <div class="box bbox6">
                    <h6 id="bottom" style="text-align: center;">Drink & <br>Desserts</h6>
                </div>
            </a>
            
        </div>
    </div>
    <h3 style = "text-align: center; padding-top : 1em; margin-bottom: 1em;">DRINKS & DESSERTS</h3>
    <div class="container">
        <div class="product_container" >
            <div class="card d-flex justify-content-between p-1" style="width: 18rem; border-radius: 12px !important ; border: 1px solid green;">
                <img class="card-img-top" src="https://cdn.1112.com/1112/public//images/products/icecream/125027_3.png" alt="Card image cap" >
                <div class="card-body1 text-center d-flex align-items-center flex-column" style="padding-bottom: 1em;">
                  <h5 class="card-title">Egg Tart Hong Kong Style 2 Pcs.</h5>
            ...
            <div class="card d-flex justify-content-between p-1" style="width: 18rem; border-radius: 12px !important ; border: 1px solid green;">
                <img class="card-img-top" src="https://cdn.1112.com/1112/public//images/products/icecream/125271_2.png" alt="Card image cap">
                <div class="card-body1 text-center d-flex align-items-center flex-column " style="padding-bottom: 1em;">
            ...
            <div class="card d-flex justify-content-between p-1" style="width: 18rem; border-radius: 12px !important ; border: 1px solid green;">
                <img class="card-img-top" src="https://cdn.1112.com/1112/public//images/products/icecream/125272_2.png" alt="Card image cap">
                <div class="card-body1 text-center d-flex align-items-center flex-column" style="padding-bottom: 1em;">
            ...
            <div class="card d-flex justify-content-between p-1" style="width: 18rem; border-radius: 12px !important ; border: 1px solid green;">
                <img class="card-img-top" src="https://cdn.1112.com/1112/public//images/products/icecream/125274_2.png" alt="Card image cap">
                <div class="card-body1 text-center d-flex align-items-center flex-column " style="padding-bottom: 1em;">
                  <h5 class="card-title">Rum Raisin Ice Cream</h5>
                  <button type="button" class="btn btn-success d-flex justify-content-between  " style ="width: 80%;height: 40px;  margin-left: 0.5rem; padding: 0.5rem;">
                    <span>10 ฿</span>
                    <span>
                        <img src="https://1112.com/images/cart_select.svg" alt="bucket">
